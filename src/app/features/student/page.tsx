    ...
    <main className="section-page">
      <div className="site-shell">
        <div className="section-head section-head-single">
          ...
          <p>
            Các tính năng này yêu cầu sinh viên đăng nhập trước khi sử dụng để bảo đảm đúng tài khoản,
          ...
          {studentLearningFeatures.map((feature) => (
            ...
            >
              ...
              <div className="feature-meta">
                ...
                <Link href={featureRouteMap[feature.slug] ?? "/features/student"}>Xem chi tiết</Link>
              </div>
            </article>
          ))}
        </div>
