...
import { DEMO_SESSION_KEY, getDemoSession } from "../lib/auth-storage";
...
const featureMenuSections = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/features/classroom-games", label: "Quiz tương tác" },
...
function readSession(): DemoSession | null {
  return getDemoSession() as DemoSession | null;
}
        ...
        <div className="header-actions">
          ...
          {session ? (
            <div className="account-shell" onMouseEnter={openAccountMenu} onMouseLeave={closeAccountMenu}>
              ...
              >
                {session.avatarUrl ? (
                  <img src={session.avatarUrl} alt={session.email} width={40} height={40} className="account-avatar-image" />
                ) : (
